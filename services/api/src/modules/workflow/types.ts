...
export type WorkflowStage = 'P1'|'P2'|'P3'|'P4'|'P4O'|'P5'|'S1'|'S2'|'S3'|'S4'|'S5'
...
export function responsibleRole(stage: WorkflowStage): Exclude<Role, 'ADMIN'> {
  if (stage === 'P2' || stage === 'P4O' || stage === 'S2' || stage === 'S4') return 'ORGANIZATION'
  if (stage === 'P4' || stage === 'S3') return 'APPROVING_AUTHORITY'
  return 'EMPLOYEE_AFFAIRS'
}

export function isOrganizationStage(stage: string): stage is 'P2'|'P4O'|'S2'|'S4' {
  return stage === 'P2' || stage === 'P4O' || stage === 'S2' || stage === 'S4'
}
